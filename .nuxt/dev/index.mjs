...
const _PNHW9479dN = (function(nitro) {
...
const _lazy_3A8cYv = () => Promise.resolve().then(function () { return albums$1; });
const _lazy_x4VnVm = () => Promise.resolve().then(function () { return auth$1; });
const _lazy_lZERgU = () => Promise.resolve().then(function () { return callback$1; });
const _lazy_JeJzxW = () => Promise.resolve().then(function () { return getAccessToken$1; });
const _lazy_D8lvKU = () => Promise.resolve().then(function () { return login$1; });
const _lazy_Fpzn4C = () => Promise.resolve().then(function () { return test; });
const _lazy_AHa71p = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/albums', handler: _lazy_3A8cYv, lazy: true, middleware: false, method: undefined },
  { route: '/api/auth', handler: _lazy_x4VnVm, lazy: true, middleware: false, method: undefined },
  { route: '/api/callback', handler: _lazy_lZERgU, lazy: true, middleware: false, method: undefined },
  { route: '/api/getAccessToken', handler: _lazy_JeJzxW, lazy: true, middleware: false, method: undefined },
  { route: '/api/login', handler: _lazy_D8lvKU, lazy: true, middleware: false, method: undefined },
  { route: '/api/test', handler: _lazy_Fpzn4C, lazy: true, middleware: false, method: undefined },
